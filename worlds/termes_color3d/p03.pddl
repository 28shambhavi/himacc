...
(:init
    ...
    (height pos-3-1 n0)
    (height pos-3-2 n0)
    (has_color pos-0-0 n0 white)
    (has_color pos-0-1 n0 white)
    (has_color pos-0-2 n0 white)
    (has_color pos-1-0 n0 white)
    (has_color pos-1-1 n0 white)
    (has_color pos-1-2 n0 white)
    (has_color pos-2-0 n0 white)
    (has_color pos-2-1 n0 white)
    (has_color pos-2-2 n0 white)
    (has_color pos-3-0 n0 white)
    (has_color pos-3-1 n0 white)
    (has_color pos-3-2 n0 white)
...
(and
    ...
    (height pos-3-2 n1)
    (has_color pos-0-0 n0 white)
    (has_color pos-0-0 n1 red)
    (has_color pos-0-1 n0 white)
    (has_color pos-0-2 n0 white)
    (has_color pos-0-2 n1 blue)
    (has_color pos-1-0 n0 white)
    ; (has_color pos-1-0 n1 blue)
    ; (has_color pos-1-0 n2 blue)
    (has_color pos-1-1 n0 white)
    (has_color pos-1-1 n1 red)
    (has_color pos-1-1 n2 blue)
    (has_color pos-1-2 n0 white)
    (has_color pos-2-0 n0 white)
    ; (has_color pos-2-0 n1 blue)
    ; (has_color pos-2-0 n2 blue)
    ; (has_color pos-2-0 n3 blue)
    (has_color pos-2-1 n0 white)
    (has_color pos-2-1 n1 red)
    (has_color pos-2-1 n2 blue)
    (has_color pos-2-2 n0 white)
    (has_color pos-3-0 n0 white)
    (has_color pos-3-0 n1 blue)
    (has_color pos-3-1 n0 white)
    ; (has_color pos-3-1 n1 red)
    ; (has_color pos-3-1 n2 red)
    (has_color pos-3-2 n0 white)
    (has_color pos-3-2 n1 red)
)
)
