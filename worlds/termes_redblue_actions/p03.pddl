...
(:init
    ...
    (height pos-3-1 n0)
    (height pos-3-2 n0)
    (has_color pos-0-0 white)
    (has_color pos-0-1 white)
    (has_color pos-0-2 white)
    (has_color pos-1-0 white)
    (has_color pos-1-1 white)
    (has_color pos-1-2 white)
    (has_color pos-2-0 white)
    (has_color pos-2-1 white)
    (has_color pos-2-2 white)
    (has_color pos-3-0 white)
    (has_color pos-3-1 white)
    (has_color pos-3-2 white)
...
(and
    ...
    ; (has_color pos-0-1 white)
    ; (has_color pos-0-2 white)
    (has_color pos-1-0 blue)
    ; (has_color pos-1-1 white)
    ; (has_color pos-1-2 white)
    (has_color pos-2-0 blue)
    ; (has_color pos-2-1 white)
    ;(has_color pos-2-2 red)
    ; (has_color pos-3-0 white)
    ; (has_color pos-3-1 white)
    ; (has_color pos-3-2 white)
)
