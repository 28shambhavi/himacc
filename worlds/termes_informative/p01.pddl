...
(:init
    ...
    (= (block_cost pos-0-1) 0.666)
    (= (block_cost pos-0-2) 0.333)
    (= (block_cost pos-1-0) 0.666)
    (= (block_cost pos-1-1) 0.333)
    (= (block_cost pos-1-2) 0)
    (= (block_cost pos-2-0) 1)
    (= (block_cost pos-2-1) 0.666)
    (= (block_cost pos-2-2) 0.333)
    (= (block_cost pos-3-0) 1.333)
    (= (block_cost pos-3-1) 1)
    (= (block_cost pos-3-2) 0.666)
    (= (total_cost) 0)
    (IS-DEPOT pos-2-0)
    (not (has-block))
)
