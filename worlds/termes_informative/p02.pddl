...
(:init
    ...
    (= (block_cost pos-0-2) 2.6)
    (= (block_cost pos-1-0) 1.3)
    (= (block_cost pos-1-1) 1.3)
    (= (block_cost pos-1-2) 2)
    (= (block_cost pos-2-0) 0.6)
    (= (block_cost pos-2-1) 0.6)
    (= (block_cost pos-2-2) 1.3)
    (= (block_cost pos-3-0) 0.6)
    (= (block_cost pos-3-1) 0.6)
    (= (block_cost pos-3-2) 1.3)
    (= (total-cost) 0)
    (IS-DEPOT pos-2-0)
)
(:goal
